...
namespace AndroidUsbSerialDriver.Driver
{
    ...
    {
        private readonly string TAG = nameof(Cp21xxSerialDriver);
        ...
        public class Cp21xxSerialPort : CommonUsbSerialPort
        {
            ...
            public override void Open(UsbDeviceConnection connection)
            {
                ...
                try
                {
                    ...
                    SetConfigSingle(SILABSER_SET_MHS_REQUEST_CODE,
                        MCR_ALL | CONTROL_WRITE_DTR | CONTROL_WRITE_RTS);
            ...
            private void SetBaudRate(int baudRate)
            {
                ...
                var ret = mConnection.ControlTransfer(
                    (UsbAddressing) REQTYPE_HOST_TO_DEVICE,
                    ...
                    4,
                    USB_WRITE_TIMEOUT_MILLIS);
                if (ret < 0) throw new IOException("Error setting baud rate.");
            }
                ...
                Parity parity)
            {
                ...
                SetConfigSingle(SILABSER_SET_LINE_CTL_REQUEST_CODE,
                    configDataBits);
            }
