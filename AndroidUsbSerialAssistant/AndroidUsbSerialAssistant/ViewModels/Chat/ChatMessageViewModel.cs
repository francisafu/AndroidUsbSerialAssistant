...
namespace AndroidUsbSerialAssistant.ViewModels.Chat
{
    ...
    public class ChatMessageViewModel : BaseViewModel
    {
        ...
        private string profileImage = "https://cdn.syncfusion.com/essential-ui-kit-for-xamarin.forms/common/uikitimages/ProfileImage3.png";
        ...
        private void GenerateMessageInfo()
        {
            ...
            this.ChatMessageInfo = new ObservableCollection<ChatMessage>
            {
                ...
                new ChatMessage
                {
                    ImagePath = "https://cdn.syncfusion.com/essential-ui-kit-for-xamarin.forms/common/uikitimages/Electronics.png",
