...
namespace AndroidUsbSerialAssistant.ViewModels.Navigation
{
    ...
    public class RecordsViewModel
    {
        ...
        ///     <see cref="T:AndroidUsbSerialAssistant.ViewModels.Navigation.RecordsViewModel" /> class.
        /// </summary>
        public RecordsViewModel()
        {
            DownloadCommand = new Command(DownloadQualityTapped);
            ShowFilesCommand = new Command(ShowHiddenFilesTapped);
            PolicyCommand = new Command(PrivacyPolicyTapped);
        }
