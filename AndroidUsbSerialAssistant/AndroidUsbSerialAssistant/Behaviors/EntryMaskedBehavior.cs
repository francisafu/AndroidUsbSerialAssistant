...
namespace AndroidUsbSerialAssistant.Behaviors
{
    ...
    public class EntryMaskedBehavior : Behavior<Entry>
    {
        ...
        public static readonly BindableProperty MaskProperty =
            BindableProperty.Create(nameof(Mask),
                typeof(string),
                typeof(EntryMaskedBehavior),
                "",
                BindingMode.Default,
                null,
                OnMaskChanged);
        ...
        public static readonly BindableProperty PrefixProperty =
            BindableProperty.Create(nameof(Prefix),
                typeof(string),
                typeof(EntryMaskedBehavior),
                "",
                BindingMode.Default,
        ...
        private static void OnMaskChanged(BindableObject bindable,
            object oldValue,
            object newValue)
        {
        ...
        private static void OnPrefixChanged(BindableObject bindable,
            object oldValue,
            object newValue)
        {
        }
